...
function BayerAccSidebar() {
  ...
  // Categorías
  const overviewItems = [
    { to: "/acc/projects", icon: FaHome, label: "Projects Page" },
    {
      to: `/acc/projects/${accountId}/${projectId}`,
  ...
  const reportsItems = [
    {
      to: `/acc/projects/${accountId}/${projectId}/users`,
      icon: FaUsers,
      label: "Users Report",
    },
    {
      to: `/acc/projects/${accountId}/${projectId}/issues`,
      icon: FaClipboardList,
      label: "Issues Report",
    },
    {
      to: `/acc/projects/${accountId}/${projectId}/rfis`,
      icon: FaEnvelope,
      label: "RFI Report",
    },
    {
      to: `/acc/projects/${accountId}/${projectId}/submittals`,
      icon: FaFileAlt,
...
export default BayerAccSidebar
