...
import { ProjectsDropdownMenu } from "../platform_general_components/general_platform_components/platfomr.projects.dropdownmenu";
...
const Acc360ProjectsHeader = ({ projectId, accountId }) => {
    ...
    useEffect(() => {
        const getProject = async () => {
            const projectData = await fetchAccProjectData(projectId, accountId);
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {projectsData?.projects?.length > 0 && (
                        <ProjectsDropdownMenu
                            ...
                            onSelect={(option) => {
                                navigate(
                                    `/acc/projects/${accountId}/${option.value}`
                                );
                            }}
                        />
                    )}
