...
const AccFolderPermitsPage = () => {
  ...
  //console.log("Folders Permissions:", foldersPermissions);
  //console.log("Folder Enriched Permissions:", folderEnrichedPermissions);
...
export default React.memo(AccFolderPermitsPage);
