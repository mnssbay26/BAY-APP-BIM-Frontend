...
/* ------------ Badge helpers ------------ */
const ADSK_COLOR_MAP = {
  "adsk-yellow-orange-500": "bg-yellow-400 text-yellow-900",
  "adsk-charcoal-900":      "bg-gray-800 text-white",
  "adsk-green-500":         "bg-green-500 text-white",
  "adsk-red-500":           "bg-red-500 text-white",
  "adsk-blue-500":          "bg-blue-500 text-white",
  "adsk-orange-500":        "bg-orange-500 text-white",
  "adsk-purple-500":        "bg-purple-500 text-white",
  "adsk-teal-500":          "bg-teal-500 text-white",
};

const renderStatusBadge = (name = "", color = null) => {
  const colorClass = ADSK_COLOR_MAP[color] || "bg-blue-100 text-blue-800";
  return (
    <Badge className={`${colorClass} hover:bg-[#164aa2] hover:text-white transition-colors`}>
      {name || "—"}
    </Badge>
  );
};
              ...
              {loading ? (
                ...
                paginated.map((asset, idx) => (
                  <TableRow key={asset.id || idx} className="hover:bg-gray-50">
                    ...
                    <TableCell className="p-2">
                      {asset.statusName
                        ? renderStatusBadge(asset.statusName, asset.statusColor)
                        : "—"}
                    </TableCell>
                    <TableCell
...
export default React.memo(AccProjectAssetsPage);
